...
/**
  * @brief  This function prints on the console the info about $PSTMSETPAR command.
  * @param  pGNSSParser_Data Handler of the GNSS data
  * @retval None
  */
...
/**
  * @brief  This function prints on the console the info about $PSTMGETPAR command.
  * @param  pGNSSParser_Data Handler of the GNSS data
  * @retval None
  */
