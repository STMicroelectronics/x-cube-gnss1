...
#define BUS_BSP_BUTTON_GPIO_CLK_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
#define BUS_BSP_BUTTON_GPIO_PIN GPIO_PIN_7
#define BUS_BSP_BUTTON_GPIO_CLK_DISABLE() __HAL_RCC_GPIOG_CLK_DISABLE()
#define BUS_BSP_BUTTON_GPIO_PORT GPIOG

#define USER_BUTTON_PIN	                  GPIO_PIN_7
#define USER_BUTTON_GPIO_PORT              GPIOG
#define USER_BUTTON_EXTI_IRQn              EXTI7_IRQn
#define USER_BUTTON_EXTI_LINE              EXTI_LINE_7
#define H_EXTI_7			  hpb_exti[BUTTON_USER]
/**
 * @}
 */
